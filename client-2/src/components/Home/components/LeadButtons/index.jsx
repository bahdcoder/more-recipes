...
const SignedInLeadButtons = () => (
  <span>
    <Link to='/recipes/create' className="btn btn-primary btn-lg mr-2" role="button">Create recipe</Link>                        
    <Link to='/user/recipes' className="btn btn-primary btn-lg" role="button">Manage your recipes</Link>
  </span>
);
