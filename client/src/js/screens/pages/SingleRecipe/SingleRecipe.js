            ...
            <div className="col-4">
              ...
              <div className="card mb-3">
                <div className="img-zoom">
                  <img className="card-img-top" style={{height: 200}} src="img/meal-6.jpg" alt="Card image cap" />                
                </div>
                <div className="card-body">
              ...
              <div className="card mb-3">
                <div className="img-zoom">
                  <img className="card-img-top" style={{height: 200}} src="img/meal-2.jpg" alt="Card image cap" />                
                </div>
                <div className="card-body">
                  <h6 className="card-title text-center">
